...
export const categories = [
  {
    ...
    description:
      "Here are the latest features we've added to Habit Builder. I'm constantly improving our product to help you ship faster.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to Habit Builder.",
  },
  {
    ...
    description:
      "Learn how to use Habit Builder with these step-by-step tutorials. I'll show you how to ship faster and save time.",
    descriptionShort:
      "Learn how to use Habit Builder with these step-by-step tutorials.",
  },
];
...
export const articles = [
  {
    ...
    title: "Introducing Supabase to Habit Builder",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with Habit Builder!",
    ...
    image: {
      ...
      alt: "Supabase and Habit Builder logo combined",
    },
